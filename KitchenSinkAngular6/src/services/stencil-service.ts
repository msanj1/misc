...
import {ui, dia, V} from '../../vendor/rappid';
...
export class CustomStencilElementView extends joint.dia.ElementView{
    // initialize(){
    //     this.listenTo(this.model, "change:position", ), this.listenTo(this.model, "change:size", this.resize), this.listenTo(this.model, "change:angle", this.rotate)
    // }

    render(){
        this.vel.empty();

          var t = joint.util.parseDOMJSON([{
            tagName: "image",
            selector: "icon",
            attributes: {
                x: 0,
                ...
                width: 20,
                height: 20,
                "xlink:href": this.model.prop("icon")
            }
        }, 
        // {
        //     tagName: "text",
    ...
    this.vel.append(<any>t.fragment);

        // this.renderJSONMarkup((<any>shape).markup);
    // this._removePorts();
         this.update();
        return this;
    }
    ...
    //     // let shape = new joint.shapes.standard.InscribedImage({
    //     //     attrs: {
    //     //         image : {
    //     //             xlinkHref: this.model.prop("icon")
    //     //         },
    //     //         label: {
    //     //             text: this.model.prop("displayName")
    //     //         }
    //     //     }
    //     // });

        
    //     // this.renderJSONMarkup(shape.get("markup") || (<any>shape).markup);


    // //     this.renderStringMarkup();
    // //     this.vel.empty();
     
    // //     var elementView = this.paper.findViewByModel(shape);
    ...
    // //     let stencilElement = V('<g><image width="20" height="20" /><text font-family="Roboto Condensed" letter-spacing="0.01em" font-size="12" fill="#191919" x="30" y="14"></text></g>');
    // //     stencilElement.findOne("image").attr('xlink:href',this.model.attributes["icon"]);
    // //     // stencilElement.node.va
    // //     stencilElement.findOne("text").text(this.model.attributes["displayName"]);

    // //     // stencilElement = stencilElement.attr('xlink:href',this.model.attributes["icon"]);
    // //     // t.fragment.
    // //     // this.vel.
    // //     // t.selectors.label.textContent = this.model.attr["label"];
    // //     // this.vel.attr("height", 20);
        
    //       this.vel.append(<any>t.fragment);
    // //     // this.renderJSONMarkup([t]);
    // //     // this
    // //     // this.vel.append(stencilElement);
    // //     this.update()
    // }
}
        ...
        this.stencil = new ui.Stencil({
            ...
            paperOptions: function () {
                return {
                    ...
                    // elementView: CustomStencilElementView
                };
            },
            label: 'Widgets',
            search: {
